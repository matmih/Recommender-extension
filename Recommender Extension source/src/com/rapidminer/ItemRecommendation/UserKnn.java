 ...
 * ItemKnn operator
 * 
 * @see com.rapidminer.ItemRecommendation.UserKnn
 * @see com.rapidminer.ItemRecommendation._userKnn
 * @see com.rapidminer.ItemRecommendation.WeightedUserKnn
 * 
	...
	public void doWork() throws OperatorException {
		...
		ExampleSet exampleSet = exampleSetInput.getData();
				...
				boolean isW = getParameterAsBoolean("Weighted Knn");
				 ...
				 if(isW==false)
					 recommendAlg=new _userKnn() ;
				 else recommendAlg=new WeightedUserKnn();
