...
/**
 *Global average predictor operator for Rating Prediction
 * 
 * @see com.rapidminer.operator.RatingPrediction.GlobalAverageO
 * @see com.rapidminer.RatingPrediction.GlobalAverage
 * 
 * @author Matej Mihelcic (Ruðer Boškoviæ Institute)
 */


public class GlobalAverageO extends Operator {
	 ...
	 * Constructor
	 */
	public GlobalAverageO(OperatorDescription description) {
		super(description);
