...
/**
 * Baseline method for rating prediction operator for Rating Prediction
 * 
 * @see com.rapidminer.operator.RatingPrediction.UserItemBaselineO
 * @see com.rapidminer.RatingPrediction.UserItemBaseline
 * 
 * @author Matej Mihelcic (Ruðer Boškoviæ Institute)
 */

public class UserItemBaselineO extends Operator{


	public static final String PARAMETER_Min="Min Rating";
	public static final String PARAMETER_Range="Range";
	public static final String PARAMETER_numIter = "num_iter";
	 ...
	 * Constructor
	 */
	public UserItemBaselineO(OperatorDescription description) {
		super(description);
