...
/**
 * Bi Polar Slope one operator for Rating Prediction
 * 
 * @see com.rapidminer.operator.RatingPrediction.CF_BiPolarSlopeOne
 * @see com.rapidminer.operator.RatingPrediction.BiPolarSlopeOne
 * 
 * @author Matej Mihelcic (Ruðer Boškoviæ Institute)
 */


public class CF_BiPolarSlopeOne extends Operator {
	 ...
	 * Constructor
	 */
	public CF_BiPolarSlopeOne(OperatorDescription description) {
		super(description);
