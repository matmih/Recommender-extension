...
public class SparseMatrix implements IMatrix_i {
			...
			public com.rapidminer.improved.HashMap<Integer, Integer> Get (int x)
					...
					public int getLocation1(int x, int y)
					{
			...
			public SparseMatrix(int num_rows, int _num_cols)
			{
			...
			{
				return new SparseMatrix(num_rows, num_columns);
			}
