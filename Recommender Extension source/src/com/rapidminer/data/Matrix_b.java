...
public class Matrix_b implements IMatrix_b {
   ...
   /// <summary>Data array: data is stored in columns.</summary>
		...
		public int dim2;
               ...
               public  boolean getLocation(int i, int j){
              ...
              public void setLocation(int i, int j, boolean value){
		...
		public Matrix_b(int dim1, int dim2)
		{
			if (dim1 < 0)
		...
		public Matrix_b(List<List<Boolean>> _data)
		{
		...
		///
		public Matrix_b CreateMatrix(int num_rows, int num_columns)
		{
			return new Matrix_b(num_rows, num_columns);
		}

		///
		public Matrix_b Transpose()
		{
			Matrix_b transpose = new Matrix_b(NumberOfColumns(), NumberOfRows());
			for (int i = 0; i < dim1; i++)
				for (int j = 0; j < dim2; j++)
		...
		{
			boolean[] column =new boolean[this.dim1];
		...
		public void SetColumn(int j, boolean[] column)
		{
		...
		public void AddRows(int num_rows)
		{
			if (num_rows > dim1)
			{
				...
				boolean[] data_new =new boolean[num_rows * dim2];
		...
		public void Grow(int num_rows, int num_cols)
		{
			...
			{
				// create new data structure
				boolean[] new_data =new boolean[num_rows * num_cols];
				for (int i = 0; i < dim1; i++)
					for (int j = 0; j < dim2; j++)
		...
		/// <param name="i">the row ID</param>
		public void SetRowToOneValue(int i, boolean v)
		{
			for (int j = 0; j < dim2; j++)
                       setLocation(i,j,v);
		}
		...
		/// <param name="v">the value to be used</param>
		/// <param name="j">the column ID</param>
		public void SetColumnToOneValue(int j, boolean v)
		{
			for (int i = 0; i < dim1; i++)
                           setLocation(i,j,v);
		}
